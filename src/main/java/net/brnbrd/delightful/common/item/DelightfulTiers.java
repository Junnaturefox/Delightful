...
public enum DelightfulTiers implements Tier {
	...
	CLOGGRUM(2, 286, 6F, 3F, 8, DelightfulItems.getIngot("cloggrum")),
	FROSTSTEEL(2, 575, 7F, 2F, 20, DelightfulItems.getIngot("froststeel")),
	UTHERIUM(3, 1279, 8.5F, 3.5F, 17, DelightfulItems.getIngot("utherium")),
	FORGOTTEN(4, 1876, 8F, 3F, 2, DelightfulItems.getIngot("forgotten_metal")),
